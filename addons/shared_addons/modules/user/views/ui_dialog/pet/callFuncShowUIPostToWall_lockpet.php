...
<?php 
	...
	$curval = $_SESSION['PET_LOCK_VAL'];  
	
	$premessage = $GLOBALS['global']['PRE_DEF_MESSAGE']['lock_pet'];
...
<div id="wrap-dialog-box">	
	...
	<div class="input">
		<div class="input-padding">
			...
			<input type="button" value="Post" class="share-2" id="submit-button-id" onclick="callFuncPostOnWall_lockpet();" />
