	...
	<div class="filter-split" style="border:1px solid #cfcfcf;position:relative;">
		...
		<?php $i=1; foreach($watchingUser as $item):?>
			...
			<div class="friend-item-s" id="itemID_<?php echo $item->user_id;?>">
                ...
                <?php if($item->user_id != getAccountUserId()): ?>
                    <div class="user-profile-username filter-split" style="padding: 3px;"> 
                        <a class="button" id="sendGift" onclick="jqcc.cometchat.chatWith('<?php echo $item->user_id;?>');" href="javascript:void(0);">Chat</a>
			        </div> 
                <?php endif;?>
			</div>
