...
<div id="rate-wrap">
	<div id="star"></div>
	<a onclick="callFuncRateObj_BACKSTAGEPHOTO(<?php echo $id_photo;?>,'<?php echo $GLOBALS['global']['RATING']['backstage_photo'];?>');" href="javascript:void(0);" class="button hidden" id="rate-button">Rate</a>
</div>
