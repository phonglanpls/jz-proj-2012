...
function callFuncShowHentaiCategory(id_category){
	...
	$.get(BASE_URI+'videos/category/category',{category_id:id_category},function(res){
		$('#HentaiVideoContextLoader_'+id_category).toggle();
...
function callFuncShowVideoHentai(id_video){
	...
	$.get(BASE_URI+'videos/category/show_video_episode',{id_video:id_video},function(res){
		$('#videoHentaiEpisodeContextLoader').toggle();
...
function callFuncShowWatchingVideoUser(id_video,mode){
	$.get(BASE_URI+'videos/category/show_watching_video',{id_video:id_video,mode:mode},function(res){
...
function callFuncShowAllWatchingUser(id_video){
	...
	$.get(BASE_URI+'videos/category/show_watching_video',{id_video:id_video,mode:'all'},function(res){
		$('#watchingUserAsyncDiv').html(res);
	});
}
