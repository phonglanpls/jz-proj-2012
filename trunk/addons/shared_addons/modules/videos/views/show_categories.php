...
<?php 
	...
	$pagination = create_pagination( 
					$uri = "videos/category/category/?category_id=$category_id", 
					$total_rows = $total , 
					$limit= $rec_per_page,
					$uri_segment = 0,
					TRUE, TRUE 
...
<?php $i=1; foreach($videoSeries as $item):?>
	...
	<div class="video-thumb-info">
		<a href="<?php echo site_url("videos/category/series/{$item->id_series}/{$slug}");?>"><img src="<?php echo $thumbPath;?>" width="160px" height="120px" /></a>
		<div class="clear"></div>
		<a href="<?php echo site_url("videos/category/series/{$item->id_series}/{$slug}");?>"><?php echo $item->name;?></a>
	</div>
