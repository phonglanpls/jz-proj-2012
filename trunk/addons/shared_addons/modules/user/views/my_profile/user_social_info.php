...
<h3>Basic Info</h3>
<div class="extralink">
	<a href="<?php echo site_url("user/my_profile/info");?>" >Edit</a>
</div>
...
<?php if($count=count($myFriends)): ?>
	<h3>Friends (<?php echo $count;?>)</h3>
	<?php if($count > 6):?>
		<div class="extralink">
			<a href="<?php echo site_url("user/my_profile/friends");?>" >More</a>
		</div>
	<?php endif;?>	
	<div class="box-profile user-profile-friendlist">
...
<?php if($count=count($myPetList)): ?>
	...
	<?php if($count > 6):?>
		<div class="extralink">
			<a href="<?php echo site_url("user/my_profile/pet_list");?>" >More</a>
		</div>
	<?php endif;?>	
...
<?php if($count=count($myGiftList)): ?>
	...
	<?php if($count > 6):?>
		<div class="extralink">
			<a href="<?php echo site_url("user/my_profile/gift_list");?>" >More</a>
		</div>
	<?php endif;?>	
