...
<?php 
	...
	$userdataobj = $this->user_io_m->init('id_user',$this->input->get('id_user',0));
	
	$data[0]['html'] = "<b>".$userdataobj->username."</b><br/>";
    $data[0]['html'] .= "<b>".cal_age($userdataobj->dob).', '.$userdataobj->gender."</b><br/>";
    $data[0]['html'] .= "<div class='filter-split'><a class=\"button\" onclick=\"jqcc.cometchat.chatWith('{$userdataobj->id_user}');\" href=\"javascript:void(0);\">Chat</a></div>";
