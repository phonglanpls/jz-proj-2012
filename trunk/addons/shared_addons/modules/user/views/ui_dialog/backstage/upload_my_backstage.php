...
<?php 
	echo form_open(
						$action = site_url("mod_io/backstage_func/submit_my_photo"), 
...
<div id="wrap-dialog-box">	
	...
	<div class="input">
		...
		<input type="text" name="price" id="price" maxlength="15" value="" style="width:200px;" />
	</div>
	
	<div class="input">
		<!-- <a href="javascript:void(0);" onclick="callFuncLoadWCUI_BACKSTAGEPHOTO();">Use your webcam to take a snapshot</a> -->
		<input type="button" value="Use your webcam" name="submitbtn" class="share-2" onclick="callFuncLoadWCUI_BACKSTAGEPHOTO();" />
