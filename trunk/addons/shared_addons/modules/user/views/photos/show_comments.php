	...
	<div class="article-response-item" id="articleDivId_<?php echo $subitem->id_photo_comment;?>">
		...
		<div class="article-response-note">
			<div class="article-response-header">
				...
				<?php //if($subitem->comment_by != getAccountUserId()):?>
				<!--
					<a href="#" class="chat">Chat</a> 
					<a href="javascript:void(0);" onclick="callFuncShowDialogSubmitQuestion(<?php echo $subitem->comment_by;?>);" class="ask-me">Ask Me</a>
				-->
				<?php //endif;?>
				<?php 
