		...
		<div class="body">
			<div id="content">
				...
				<div class="filter-split">
					<?php $this->load->view("user_profile/visitor/user_social_info", array('userdataobj'=>$userdataobj)); ?>
				</div>
				
				<div class="clear"></div>
				 
				<div class="filter-split">
					<?php $this->load->view("user_profile/visitor/user_chatter", array('userdataobj'=>$userdataobj)); ?>
