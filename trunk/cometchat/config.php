...
define('BASE_URL','/juzon/cometchat/');

define('JUZ_BASE_URL', 'http://localhost/juzon/');
/* BASE URL END */
...
$trayicon[] = array('backstage','Upload Backstage Photos','javascript:callFuncLoadUploadMyBackstagePhoto();','','','','','','1');
...
$plugins = array('smilies','chathistory','clearconversation','block','gift','pet','map','backstage','peep','favourite');
...
$thumbnailDisplayNumber = '0';			// The number of users in Whos Online list after which thumbnails will be hidden
