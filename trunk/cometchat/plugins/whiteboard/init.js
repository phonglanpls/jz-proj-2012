        ...
        return {
			...
			init: function (id) {
				...
				if (currenttime-lastcall > 10) {
					...
					loadCCPopup(baseUrl+'plugins/whiteboard/index.php?action=whiteboard&id='+id+'&basedata='+baseData, 'whiteboard',"status=0,toolbar=0,menubar=0,directories=0,resizable=1,location=0,status=0,scrollbars=0, width=640,height=480",640,480,'<?php echo $whiteboard_language[9];?>',1);
