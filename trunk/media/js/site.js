...
function closeCMCpopupWD(){
	$('.cometchat_tabpopup').removeClass('cometchat_tabopen');
	/***
	$('.cometchat_tabpopup.cometchat_tabopen').each(function(i,o){
		$zindex = parseInt( $(this).css('z-index') );
		$(this).css({'z-index':$zindex+2}).removeClass('cometchat_tabopen'); 
	});
	**/
}
